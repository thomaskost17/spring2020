...
Note that this document is broken down by a section containing the code and a section containing the results. Any written answers for this question will be contained in the results section along with the corresponding graphs.
...
The data is plotted and labeled in Figure 1. As we can see from the plot, the data is not linearly seperable.

![Data Visualization](2a.jpg)

### 2B

Figure 2 shows the plot of different values of k against the accuracy produced by each model.
![KNN accuracy](2b.jpg) 
